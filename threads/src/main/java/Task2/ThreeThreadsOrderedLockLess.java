...
public class ThreeThreadsOrderedLockLess {
                ...
                synchronized (object) {
                    ...
                    if (sharedOutput.get() % 3 == this.threadPosition) {
                        ...
                        if(sharedOutput.get() < 9)
                        {
                            ...
                            System.out.println(/*Thread.currentThread()+*/makeFibonacci(sharedOutput.get())+"  "+
    ...
    public static int makeFibonacci(int count){
        int n = count, t1 = 0, t2 = 1;
        System.out.print("Element " + n + " in fibonacci sequance ");
